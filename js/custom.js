...
function createCopyBtns() {
  ...
  if ($codeArea.length > 0) {
      ...
      $("figure").before('<div id="copyBtn" style="opacity: 0; position: absolute;top:0px;display: none;z-index:2; font-size:12px"><span id="imgCopy" >复制</span><span id="imgSuccess" style="display: none;">成功</span>');
